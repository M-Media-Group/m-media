...
class HomeController extends Controller
{
    ...
    {
        return redirect()->to('/users/' . $request->user()->id . '/billing', 301);
    }
    ...
    public function pricing(Request $request)
    {
        ...
        $plans = \Stripe\Plan::all(['expand' => ['data.product'], 'limit' => 100]);
        $products = \Stripe\Sku::all(['expand' => ['data.product'], 'limit' => 100]);
