<template>
    <div>
        <transition-group name="fade" mode="out-in">
            <form @submit.prevent="updateFile" action="#" method="POST" enctype="multipart/form-data" v-show="!success && !error && !loading" key="1" class="mb-0">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input name="title" v-model="title" id="title" class="form-control" type="text" placeholder="Descriptive titles help us tag the file">
                    </div>
...
Echo.private('App.User.1')
    ...
    updateFile: function () {
        ...
        //data.append('_method', 'put'); // add this
        axios.get('/api/user') // change this to post )
        .then(res =>{
            console.log("Go get");
