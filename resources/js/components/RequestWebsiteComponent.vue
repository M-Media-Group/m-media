...
<!--         <transition-group name="fade">
 -->            <form method="POST" action="/custom-notifications" key="requestWebsiteForm" v-on:submit.prevent="current_tab == 2 ?  updateFile() : current_tab += 1; " v-show="!success && !error && !loading">
...
<!--             <transition-group name="fade">
 -->
                <div v-if="current_tab == 0" key="tab_0">
                    ...
                    <div class="form-group row">
                        <label for="business_description" class="col-md-12 col-form-label ">A little about your business</label>
                        <div class="col-md-12">
                            <textarea-autosize
                ...
                <div v-if="current_tab == 2" key="tab_2">
                    ...
                    <div class="form-group row">
                        <label for="phone" class="col-md-12 col-form-label">Your phone number <small>(optional)</small></label>
                        ...
                        <div class="col-md-12">
                            ...
                            />
                            <span class="text-muted small">Your phone number helps us verify who you are. You don't have to provide it, but if you do, we promise not to call you without your consent.</span>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        updateFile: function () {
            ...
            var message_to_send = "Business name: "+this.business_title + "\n\n Business description: " + this.business_description + "\n\n Message: " + this.message;
