...
<h2 data-aos="fade">Other case studies</h2>
 <a class="header-section d-block text-center u-bg-primary card mb-5" href="/case-studies/breathe-as-one-festival" data-aos="fade">
    ...
    <a class="header-section d-block text-center text-dark card mb-5" style="background:initial;" href="/case-studies/justbookr" data-aos="fade">
    ...
    <a class="header-section d-block text-center u-bg-secondary card mb-5" href="/case-studies/nicolas-pisani-real-estate-agents" data-aos="fade">
