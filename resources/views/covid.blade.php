...
@endphp
        ...
        <div class="header-section" style="background: var(--white);">
            <h1>There's <span class="text-primary">{{number_format($cases['Global']['All']['confirmed'])}}</span> confirmed cases of Coronavirus around the world today.</h1>
            ...
            <div id="svgMapPopulationFrame"></div>
            ...
            <a class="button button-primary" href="https://github.com/sponsors/M-Media-Group?o=esb" rel="noopener" data-aos="fade">Donate to the API</a>
{{--             <a class="button button-primary mt-3 mb-5" href="/contact" data-aos="fade" data-aos-delay="500">Talk to an expert now</a>
            <a class="button button-primary text-white d-none" href="/case-studies">See case studies</a> --}}
        </div>
    ...
    <div class="header-section row m-0 bg-secondary">
        <div class="twelve columns">
 ...
 --}}        </div>
    ...
    <div class="header-section row m-0 bg-primary">
        <div class="twelve columns">
            ...
            <a class="button button-secondary u-center" href="https://www.who.int/emergencies/diseases/novel-coronavirus-2019/advice-for-public" rel="noopener" data-aos="fade">Read the WHO recommendations</a>
        </div>
    </div>
