...
@section('above_container')
    ...
    <div class="header-section bg-secondary"  style="background:url('/images/laptop-and-person.svg'), var(--secondary);background-position: 67vw, bottom;background-repeat: no-repeat;background-size: contain;">
        <h1>Websites that don't cost an 💪 and a 🦵.</h1>
        <p data-aos="fade">Web services for entrepreneurs.</p>
        <a class="button button-primary mt-5 mr-3" href="/contact" data-aos="fade">Contact us</a>
